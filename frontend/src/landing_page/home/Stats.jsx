        ...
        <div className="container p-3">
            <div className="row p-5">
                <div className="col-6 p-5">
                    ...
                    <p className='text-muted'>Not just an app, but a whole ecosystem. Out investments in 30+ fintech startups offer you tailored services specific to your needs.</p>
                    <h2 className='fs-4'>Do better with money</h2>
                    <p className='text-muted'>With intiatives like Nudge and Kill Swich, we don't just facilitate transactions, but actively help you do better with your money.</p>
                </div>
                <div className="col-6 p-5">
